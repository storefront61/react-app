...
$sql = "INSERT INTO forgotpassword (`user_id`, `rkey`, `rtime`, `status`) VALUES ('$user_id', '$key', '$time', '$status')";
$result = mysqli_query($link, $sql);
if(!$result){
    echo '<div class="alert alert-danger">There was an error inserting the users details in the database!</div>';
    // echo '<div class="alert alert-danger"> Error: ' . mysqli_error() . '</div>'; 
    exit;
}
...
$message .= "http://stevenagreene.offyoucode.co.uk/notesApp/resetpassword.php?user_id=$user_id&key=$key";

if(mail($email, 'Reset your password', $message, 'From:'.'steven654765@gmail.com')){
