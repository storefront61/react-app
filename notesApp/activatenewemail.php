...
$sql = "UPDATE userinfo SET email='$newemail', activation2='0' WHERE (email='$email' AND activation2='$key') LIMIT 1";
...
if($result){
    ...
    //Show error message
    echo '<div class="alert alert-danger">Your email could not bum be updated. Please try again later.</div>';
