...
$sql = "SELECT * FROM userinfo WHERE email='$newemail'";
...
$sql = "UPDATE userinfo SET activation2='$activationKey' WHERE user_id = '$user_id'";
$result = mysqli_query($link, $sql);
if(!$result){
...
$message .= "http://stevenagreene.offyoucode.co.uk/notesApp/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
if(mail($newemail, 'Email Update for you Online Notes App', $message, 'From:'.'steven654765@gmail.com')){
